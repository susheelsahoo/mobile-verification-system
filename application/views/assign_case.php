...
$("#email").val(data.email);
            ...
            // $(document).on('click', '.view_app_end_assigned_case', function() {
            //     var user_id = $(this).attr("id");
            //     $.ajax({
            //         url: "<?php echo base_url(); ?>Assign_case_controller/fetch_single_assignee_from_app_end",
            //         method: "POST",
            //         data: {
            //             user_id: user_id
            //         },
            ...
            //         dataType: "json",
            //         success: function(data) {
            //             $('#app_end_assign_view_model').modal('show');
            //             $('.s_fi_status').html("<b>FI Status:</b> " + data.fi_status);
            //             $('.s_make_model').html("<b>Make Model:</b> " + data.make_model);
            //             $('.s_loan_amt').html("<b>Loan Amount:</b> " + data.loan_amt);
            //             $('.s_confirm_address').html("<b>Confirm Address:</b> " + data.confirm_address);
            //             $('.s_person_met_details').html("<b>Person Met Details:</b> " + data.person_met_details);
            //             $('.s_relationship').html("<b>Relationship:</b> " + data.relationship);
            //             $('.s_stability').html("<b>Residence ownership:</b> " + data.stability);
            //             $('.s_user_permanent_address').html("<b>Permanent Address:</b> " + data.user_permanent_address);
            //             $('.s_rent_per_month').html("<b>Rent Per Month:</b> " + data.rent_per_month);
            //             $('.s_total_family_member').html("<b>Total family member:</b> " + data.total_family_member);
            //             $('.s_no_of_earning_members').html("<b>No. of Earning members:</b> " + data.no_of_earning_members);
            //             $('.s_details_of_earning_members').html("<b>Details of earning members:</b> " + data.details_of_earning_members);
            //             $('.s_dependent').html("<b>Dependent:</b> " + data.dependent);
            //             $('.s_user_office_address').html("<b>Office Address:</b> " + data.user_office_address);
            //             $('.s_residence_proof').html("<b>Residence Proof:</b> " + data.residence_proof);
            //             $('.s_agriculture_land').html("<b>Agriculture land (If any):</b> " + data.agriculture_land);
            //             $('.s_exterior_premises').html("<b>Exterior Premises:</b> " + data.exterior_premises);
            //             $('.s_interior_premises').html("<b>Interior Premises:</b> " + data.interior_premises);
            //             $('.s_cross_verified_info').html("<b>Cross Verified Info:</b> " + data.cross_verified_info);
            //         }
            //     });
            // });
                                   ...
                                   <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pt-4">
                                                <div class="col-sm-4">
                                                <img class="rv_image1" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="rv_image2" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="rv_image3" height="200" width="200"></div>
                                            </div>
                                        </div>
                                    </div>
<br>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pt-4">
                                                <div class="col-sm-4">
                                                <img class="rv_image4" height="200" width="200"> </div>
                                                <div class="col-sm-4">
                                                <img class="rv_image5" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="rv_image6" height="200" width="200"></div>
                                            </div>
                                        </div>
                                    </div>
                                      <br>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pt-4">
                                                <div class="col-sm-4">
                                                <img class="rv_image7" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="rv_image8" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="rv_image9" height="200" width="200"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
    ...
    <div id="bv_type_view_modal" class="modal fade " aria-hidden="true"
     data-mdb-backdrop="true"
     data-mdb-keyboard="true">
		<div class="modal-dialog modal-fullscreen">
			<div class="modal-content">
...
(Strictly Private & Confidential)</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pt-4">
                                                <div class="col-sm-4">
                                                <img class="bv_image1" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="bv_image2" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="bv_image3" height="200" width="200"></div>
                                            </div>
                                        </div>
                                    </div>
<br>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pt-4">
                                                <div class="col-sm-4">
                                                <img class="bv_image4" height="200" width="200"> </div>
                                                <div class="col-sm-4">
                                                <img class="bv_image5" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="bv_image6" height="200" width="200"></div>
                                            </div>
                                        </div>
                                    </div>
                                      <br>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="row pt-4">
                                                <div class="col-sm-4">
                                                <img class="bv_image7" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="bv_image8" height="200" width="200"></div>
                                                <div class="col-sm-4">
                                                <img class="bv_image9" height="200" width="200"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                                             ...
                                                             <h4 class="modal-title">Update BV Details</h4>
                                                                ...
                                                                <div class="card-body">  
                                                                  ...
                                                                  <div class="form-row">
                                                                    ...
                                                                    <!-- <div class="form-row">
                                                                        <div class="form-group col-md-12">
                                                                            <label for="rv_neighbour_check2" class="h6">Neighbour Check 2<span class=""> *</span></label>
                                                                            <input type="text" class="form-control" id="u_rv_neighbour_check2" placeholder="Neighbour Check" name="rv_neighbour_check2">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group col-md-12">
                                                                            <label for="rv_cpv_done_by" class="h6">CPV<span class=""> *</span></label>
                                                                            <input type="text" class="form-control" id="u_rv_cpv_done_by" placeholder="CPV done by" name="rv_cpv_done_by">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group col-md-12">
                                                                            <label for="rv_remarks" class="h6">Remarks<span class=""> *</span></label>
                                                                            <input type="text" class="form-control" id="u_rv_remarks" placeholder="Add Remarks (if any) here" name="rv_remarks">
                                                                        </div>
                                                                    </div> -->
