                            ...
                            <div class="col-sm-12 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="rv_edit_model" class="modal fade" aria-hidden="true" data-mdb-backdrop="true" data-mdb-keyboard="true">
                                            <div class="modal-dialog modal-fullscreen">
                                                <!--<form method="post" id="user_form">-->
                                                <div class="modal-content">
                                        ...
                                        <div id="bv_edit_model" class="modal fade" aria-hidden="true" data-mdb-backdrop="true" data-mdb-keyboard="true">
                                            <div class="modal-dialog modal-fullscreen">
                                                <!--<form method="post" id="user_form">-->
                                                <div class="modal-content">
