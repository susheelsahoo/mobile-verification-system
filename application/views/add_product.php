...
<script>
        $(document).ready(function() {
            ...
            var dataTable = $('#fetch_product_data').DataTable({
                "processing": true,
                "serverSide": true,
                "order": [],
                "ajax": {
                    url: "<?php echo base_url() . 'Add_product_controller/fetch_all_product'; ?>",
                    type: "POST",
                },
                "columnDefs": [{
                    "targets": [3],
            ...
            $('#fetch_product_data').editable({
                ...
                container: 'body',
                selector: 'td.status',
                url: '<?php echo base_url() . 'Add_product_controller/get_status_product'; ?>',
                title: 'Status',
                type: 'POST',
                datatype: 'json',
                source: [{
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            $('#fetch_product_data').DataTable().ajax.reload();
                            // reset the form
                            me[0].reset();
...
?>
    ...
    <div class="mybtn-left">
        <button type="button" class="btn btn-primary btn-md" data-toggle="modal" id="add_button" data-target="#add_product_model">Add Product</button>
    </div>

    <div class="tab-pane container active text-dark" id="home">
        <div class="table-responsive text-dark ">
            <br>
            <table id="fetch_product_data" class="table table-bordered table-striped">
                <thead>
                    <tr class="">
                        <th width="6%">ID</th>
    ...
    <div id="add_product_model" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('Add_product_controller/add_product_validation', array('id' => 'form_add_product')) ?>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="product" class="h5">Product</label>
                ...
                <div class="modal-footer">
                    <input type="submit" name="add_product" id="add_product_data" class="btn btn-primary" value="Add">
