...
<body>
  ...
  <figure data-title="CASES" style="color:#0e88c5;">
    <figcaption>
      ...
      <div class="card">
        <div class="title">
          <h3><b>Search Case</b></h3>
        </div>
        <div class="content">
          <div class="social">
            <i class="fab fa-codepen"></i>
            <h4 style="color:#525251;">View Details, Change Status</h4>
          </div>
          <div class="social">
            <i class="fab fa-linkedin"></i>
            <h4 style="color:#525251;">Reallocate & Clone Cases</h4>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div class="content">
          <div class="social">
            <i class="fab fa-codepen"></i>
            <h4 style="color:#525251;">Upload Case</h4>
          </div>
          <div class="social">
            <i class="fab fa-linkedin"></i>
            <h4 style="color:#525251;">for Field Investigation</h4>
          </div>
        </div>
        <div class="circle"></div>
      </div>
      ...
      <!-- <div class="card">
        <div class="title">
          <h3><b>FI Template</b></h3>
        </div>
        <div class="content">
          <div class="social">
            <i class="fab fa-codepen"></i>
            <h4 style="color:#525251;">Download</h4>
          </div>
          <div class="social">
            <i class="fab fa-linkedin"></i>
            <h4 style="color:#525251;">your FI Template</h4>
          </div>
        </div>
        <div class="circle"></div>
      </div> -->
      ...
      <div class="card">
        <div class="title">
          <a href="<?php echo base_url(); ?>Case_form/case_details_form">
            <h3><b>Create Case</b></h3>
          </a>
        </div>
        <div class="content">
          <div class="social">
            <i class="fab fa-codepen"></i>
            <h4 style="color:#525251;">View Case & Details</h4>
          </div>
          <div class="social">
            <i class="fab fa-linkedin"></i>
            <h4 style="color:#525251;"> Create Case</h4>
          </div>
        </div>
        <div class="circle"></div>
      </div>
      ...
      <div class="card">
        ...
        <div class="content">
          <div class="social">
            <i class="fab fa-codepen"></i>
            <h4 style="color:#525251;">Create Quick Case</h4>
          </div>
          <div class="social">
            <i class="fab fa-linkedin"></i>
            <h4 style="color:#525251;">View Details, Reallocate & Clone.</h4>
          </div>
        </div>
        <div class="circle"></div>
      </div>
      ...
      <div class="card">
        ...
        <div class="content">
          <div class="social">
            <i class="fab fa-codepen"></i>
            <h4 style="color:#525251;">View TAT Details</h4>
          </div>
          <div class="social">
            <i class="fab fa-linkedin"></i>
            <h4 style="color:#525251;">Serach,View TAT Details</h4>
          </div>
        </div>
        <div class="circle"></div>
      </div>
